    ...
    <div className="relative overflow-hidden min-h-[80vh] flex flex-col items-center justify-center">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0">
        <div
          ...
          style={{ background: "radial-gradient(circle, rgba(232,164,59,0.15) 0%, rgba(232,144,106,0.08) 50%, transparent 100%)" }}
        />
        <div
          className="absolute bottom-0 left-0 h-[20rem] w-[20rem] rounded-full blur-[80px]"
          style={{ background: "radial-gradient(circle, rgba(91,156,246,0.10) 0%, transparent 70%)" }}
        />
      </div>
      ...
      <div className="relative flex flex-col items-center py-20 text-center md:py-28 max-w-4xl mx-auto">
        {/* Badges */}
        <div className="flex flex-wrap items-center justify-center gap-2 animate-fade-up" style={{ animationDelay: "0ms" }}>
        ...
        <h1
          ...
          style={{
            animationDelay: "80ms",
            background: "linear-gradient(135deg, var(--text-primary) 0%, var(--brand-primary) 55%, var(--text-secondary) 100%)",
        ...
        <div className="mt-10 flex flex-wrap items-center justify-center gap-3 animate-fade-up" style={{ animationDelay: "240ms" }}>
          <Link href="/chat" className={buttonClasses({ variant: "primary", size: "md" })}>
            {t('home.ctaChat')}
          </Link>
          <Link href="/data" className={buttonClasses({ variant: "outline", size: "md" })}>
            {t('home.ctaUpload')}
          </Link>
          <Link href="/settings" className={buttonClasses({ variant: "outline", size: "md" })}>
            {t('home.ctaConfigure')}
          </Link>
        </div>
        ...
        >
          {["RAG Pipeline", "pgvector", "Streaming Responses", "Multi-LLM", "Document Permissions", "Citations"].map((feat) => (
            <span
              key={feat}
